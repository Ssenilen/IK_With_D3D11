...
public:
	...
	static void ExecuteBackwardReaching(std::vector<CBoneObject*>::iterator& BoneIter, std::vector<CBoneObject*>::iterator& BoneIterEnd, const D3DXVECTOR3& d3dxvTargetPos);
};
